...
#include <memory>
#include "../Server/EmailServer/emailclient.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_EMailClient_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_EMailClient_t qt_meta_stringdata_EMailClient = {
    {
QT_MOC_LITERAL(0, 11) // "EMailClient"
...
const QMetaObject EMailClient::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_EMailClient.offsetsAndSize,
    qt_meta_data_EMailClient,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_EMailClient_t
